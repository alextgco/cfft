(function() {
  ...
  MB.Form.parseprofile = function(data, callback) {
    var i, i2, key, parsedprofile, value, value2, _i, _j, _len, _len1, _ref, _ref1, _ref2;
    parsedprofile = {};
  ...
  MB.Form.prototype.makeportletcontainer = function(callback) {
    var general, html, i, instance, list, value, _columns, _i, _j, _len, _len1, _ref;
    instance = this;
  ...
  MB.Form.prototype.updateview = function(part, callback) {
    var $container, $fw, $input, $toggler, active, column, columns, data, editable, editor, general, html, i, id, insertable, instance, isprimary, prepareInsertExists, prepareInsertIndex, required, result, returnscolumn, returnscolumnid, table, text, updatable, val, value, _i, _j, _k, _l, _len, _len1, _len10, _len11, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _s, _t;
    instance = this;
  ...
  MB.Form.prototype.updatecontroller = function(part, callback) {
    var $container, changeDate, column, columns, data, general, handleSelect2, handleSelect2ForActionForm, handleSelect2FreeType, i, initSelect2, initSelect2ForActionForm, initSelect2FreeType, instance, process, _fn, _fn1, _fn2, _fn3, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
    instance = this;
    general = this.profile.general;
    data = this.data;
    columns = this.profile.columns;
    ...
    handleSelect2 = function($input, column, i, isSelect2withEmptyValue, editOrAdd, isAfterAdd) {
      ...
      return $input.on("change", function(e) {
        var accolumns, acobject, acreturnscolumns, ii, o, returnscolumn, val, value, where, _i, _len, _results;
        console.log(e);
        ...
        if (isSelect2withEmptyValue && val === "") {
          _results = [];
          for (ii = _i = 0, _len = acreturnscolumns.length; _i < _len; ii = ++_i) {
            value = acreturnscolumns[ii];
            _results.push(instance.$container.find("[data-column='" + value + "'] input").val(""));
          }
          return _results;
          ...
          return MB.Core.sendQuery(o, function(res) {
            ...
            _results1 = [];
            for (ii = _j = 0, _len1 = acreturnscolumns.length; _j < _len1; ii = ++_j) {
              value = acreturnscolumns[ii];
              _results1.push(instance.$container.find("[data-column='" + value + "'] input").val(res.DATA[0][ii]).trigger('change'));
            }
            return _results1;
          });
        }
    ...
    handleSelect2ForActionForm = function($input, column, i, editOrAdd, isAfterAdd) {
      ...
      return $input.on("change", function(e) {
        var accolumns, acobject, acreturnscolumns, o, pattern, returnscolumn, returnscolumnForStorage, test, val, valForStorage, where, _columns;
        _columns = instance.profile.columns;
        ...
        if (test) {
          ...
          if (_columns.accolumns[i]) {
            ...
            return MB.Core.sendQuery(o, function(res) {
              var editorType, ii, value, _i, _len, _ref, _results;
              _ref = res.NAMES;
              _results = [];
              for (ii = _i = 0, _len = _ref.length; _i < _len; ii = ++_i) {
                ...
                switch (editorType) {
                  ...
                  case "select2FreeType":
                    _results.push(instance.$container.find("[data-column='" + value + "'] input").select2("data", {
                      id: res.DATA[0][ii],
                      text: res.DATA[0][ii]
                    }));
                    break;
                  default:
                    _results.push(instance.$container.find("[data-column='" + value + "'] input").val(res.DATA[0][ii]).trigger('change'));
                }
              }
              return _results;
            });
      ...
      return $input.on("change", function(e) {
        ...
        if (test) {
          ...
          if (columns.accolumns[i]) {
            ...
            return MB.Core.sendQuery(o, function(res) {
              var editorType, ii, value, _i, _len, _results;
              _results = [];
              for (ii = _i = 0, _len = acreturnscolumns.length; _i < _len; ii = ++_i) {
                value = acreturnscolumns[ii];
                editorType = instance.profile.columns.editor[instance.profile.columns.columnsdb.indexOf(value)];
