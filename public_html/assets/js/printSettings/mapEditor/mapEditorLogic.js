...
var mapEditorLogicInit = function(mapEditor_map){
    ...
    var mapObjectsCopier = {
        ...
        populateParamsForCopy: function(type, original, objToCreate, layerId, callback){
            ...
            objToCreate.scale = original.scaleCoef;
            objToCreate.scaleCoef = original.scaleCoef;
    ...
    $(uniqueEditor).on('click', '.copyObject', function(e){
        ...
        switch(parseInt(objectType)){
            ...
            case 1:
                ...
                objToCreate.scale = obj.scaleCoef;
                objToCreate.scaleCoef = obj.scaleCoef;
    ...
    $(uniqueEditor).on('click', '.objectItem', function(e){
        ...
        console.log(editor.getSelectedObjectsIds())
