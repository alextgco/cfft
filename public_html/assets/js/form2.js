...
(function() {
  ...
  MB.Form.prototype.updateview = function(part, callback) {
    var $container, $fw, $input, column, columns, data, editable, editor, general, html, i, insertable, instance, isprimary, prepareInsertExists, prepareInsertIndex, prepareInsertValue, table, updatable, val, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
    instance = this;
  ...
  MB.Form.prototype.updatecontroller = function(part, callback) {
    var $container, column, columns, data, general, i, instance, process, _fn, _fn1, _fn2, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
    instance = this;
    general = this.profile.general;
    data = this.data;
    columns = this.profile.columns;
