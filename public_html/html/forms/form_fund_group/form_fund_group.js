...
//            </query>
            ...
            MB.Core.sendQuery({
                ...
                for(var i in res.DATA){
                    alreadyAdded.push(res.DATA[i][res.NAMES.indexOf("USER_ID")]);
                }
            ...
            MB.Core.sendQuery({
                ...
                for(var i in res.DATA){
                    ...
                    if($.inArray(userItem[users.NAMES.indexOf("USER_ID")], alreadyAdded) != -1){
                        continue;
                    }
                    var data = {
                        userId: userItem[users.NAMES.indexOf("USER_ID")],
                        name: userItem[users.NAMES.indexOf("FULLNAME")],
                        role: userItem[users.NAMES.indexOf("STATUS_RU")]
                    };
                ...
                MB.Core.sendQuery({
                    ...
                    for(var i in res.DATA){
                        var roleItem = res.DATA[i];
                        var data = {
                            roleId: roleItem[roles.NAMES.indexOf("ROLE_ID")],
                            roleName: roleItem[roles.NAMES.indexOf("NAME")]
                        };
                        ...
                        MB.Core.sendQuery({
                            ...
                            for(var i in res.DATA){
                                ...
                                var data = {
                                    userId: userItem[users.NAMES.indexOf("USER_ID")],
                                    name: userItem[users.NAMES.indexOf("FULLNAME")],
                                    role: userItem[users.NAMES.indexOf("ROLE_NAME")]
                                };
                                lBlockHtml += Mustache.to_html(itemTpl, data);
                            }
