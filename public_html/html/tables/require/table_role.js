					...
					switch (key){
						case "goToEditRole":
							...
							if(selectedRows[0] == selectedRows[1]){
								...
								var role_id = instance.data.data[selectedRows[0]][instance.data.names.indexOf('ROLE_ID')];
								MB.Core.switchModal({
									type:"content",
									filename:"roleAccess",
									params:{
                        ...
                        case "copyRole":
                            ...
                            var role_id2 = instance.data.data[selectedRows2[0]][instance.data.names.indexOf('ROLE_ID')];
                            var o = {
                                command: 'operation',
                                object: 'copy_role',
                                params: {
