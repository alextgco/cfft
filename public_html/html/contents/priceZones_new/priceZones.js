...
//                console.log(primalData);
                ...
                contentWrapper.find(".for_price_groups").html(Mustache.to_html(tpl,mo));
...
//                }
    ...
    function loadCurrentPricing(){
            ...
            bootbox.dialog({
                ...
                buttons: {
                    save: {
                        ...
                        className: "green",
                        callback: function() {
                            contentWrapper.find("#pricing_save_btn").click();
                        }
                    },
                    refresh:{
                        label: "Обновить",
        ...
        MB.Core.sendQuery({command:"get",object:"price_zone_pricing_item",sid:sid,params:{where:"price_zone_pricing_id="+environment.price_zone_pricing_id}},function(data){
            ...
            //html += ;
            contentWrapper.find("#for_pricing_row").html(html);
