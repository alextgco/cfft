...
////*****--------------------------------------------------------------------------------------------------------**//
   ...
   /* mapEditor_map.container.on('add_squares',function(e,obj){
    ...
    mapEditor_map.copySelection = function(){
        ...
        var dX = maxX-minX;
        var object_id = mapEditor_map.squares[selection[0]].object_id;
        var sq = {
            row_count:1,
        ...
        mapEditor_map.container.trigger("addSquare",[sq,function(result){
            ...
            mapEditor_map.reLoad(function(){
                var addedSquares = data['results'][0].info.split(',');
                var ids = [];
                mapEditor_map.clearSelection();
                var sqs = [];
                for (var i in selection) {
                    ...
                    targetSquare.x = originalSquare.x + dX +50;
