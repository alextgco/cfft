...
var clientScreen = {
	...
	'</div>' +
	'</div>' +
	'<div id="clientScreenModalPlace"></div>',

	orderTemplate: '<div id="orderTpl-wrapper">' +
	...
	setSquares: function () {
		...
		var availHeight = hei - parseInt($('#clientScreenInner').css('margin-top')) - parseInt($('#clientScreenInner').css('margin-bottom')) - $('#clientScreenTitle').outerHeight();
	...
	renderAfisha: function (data) {
		...
		blocks.parent.html(Mustache.to_html(this.afishaTemplate, dataToRender));
		this.setSquares();
