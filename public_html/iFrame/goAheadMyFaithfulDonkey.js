var globalIsIe8,box,agent_percent,host,frame,iFrameLegend_position,rules_path;
            ...
            MW.renderHall = function(id, callback){
                ...
                socketQuery(o,function(result){
                    ...
                    fWrapper.html('<div id="action_web">' +
                        ...
                        '                    <div class="iFrameHeadline">Стоимость мест:</div>' +
...
//                                            });
        ...
        $.getScript(params.host+"socket.io/socket.io.js",function(){
            ...
            $.getScript(params.host+"iFrame/coreIe8.js",function(){
