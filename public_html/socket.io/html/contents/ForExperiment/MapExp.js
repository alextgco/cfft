...
chairImg.src = "upload/vvv3.png";



function MapExp(params){
    var self = this;
    this.box = "";
    this.canvas = "";
    this.ctx = '';
    ...
    this.init = function(){
        ...
        this.backgroundImage.src = "upload/BG.png";
        this.shadowImage.src = "upload/shadow2.png";
    ...
    this.createSquares = function(data){
        ...
        var self = this;
        if (this.firstLoad){
            self.chairImg.src = "upload/vvv3.png";
            ...
            self.box.children("canvas").on("mousemove",function(e,delta){
    ...
    this.drawSquaresChild = function(key,cw,ch){
        ...
        /*       if (chairImg.loaded)
         ...
         if (this.chairImg.loaded) {
             ...
             this.ctx.drawImage(this.chairImg,x,y,w*$("#XY_coef").val()*this.scaleCoeff,h*$("#XY_coef").val()*this.scaleCoeff);
         }
...
function MapExp(params){
    ...
    this.loadImage = function(){
        var canvas = this.box.children("canvas")[0];
...
/*self.ctx.clearRect(0,0,self.cWidth,self.cHeight);
        self.ctx.drawImage(self.image,x,y);*//*
...
/* if (x>2000) return;
        ...
        this.ctx.drawImage(this.image,this.XCoeff,this.YCoeff,this.cWidth*1,this.cHeight*1);
...
/*$(xml).find("ROWSET").find("ROW").each(function(index) {
        ...
        //log("Squares loaded..." + this.maxY);
        if (this.firstLoad){
            self.chairImg.src = "upload/chair2.png";
            self.box.scrollControl = function(){
                if (self.timerForMouseWheel!=undefined) return;
                self.timerForMouseWheel = window.setInterval(function(){
                    if (!self.mouseWheelFlag){
                    ...
                    case 1:
                        ...
                        switch (self.keyboardKey){
                            case 32:
                                ...
                                self.XCoeff += x - self.oldMouseX;
                                self.YCoeff += e.offsetYy - self.oldMouseY;
                                self.render();
                                self.oldMouseX = x;
                                self.oldMouseY = y;
...
/*
        ...
        if (this.chairImg.loaded)
            this.ctx.drawImage(this.chairImg,x,y,w*this.scaleCoeff,h*this.scaleCoeff);
