...
//        };
        ...
        RP.renderHall = function(action_id){
            ...
            insertHtml(function(){
                RP.blocks.boxForHall.find('#box_for_multibooker_frame').append(zoomBtn);
                RP.blocks.boxForHall.find('#box_for_multibooker_frame').append(moveBtn);
        ...
        RP.setHallHandlers = function(){
            ...
            var moveBottom = $('#move-bottom');
            var moveleft = $('#move-left');

            console.log(zoomIn, zoomOut, moveTop, moveBottom);
        };
