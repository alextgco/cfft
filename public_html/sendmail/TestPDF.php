...
<head>
  ...
  <img class="logo barvihaLogo" src="img/barviha_logo.png" height="60"/>
  ...
  <div class="barcode_left"><div><img src="barcode39.gif"/></div></div>
    ...
    <table class="legalInfo">
        <tr>
            ...
            <td>
                <span class="mirBLegal">
                    ЗАО "Юниверсал Холл Менеджемент"<br />
                    143082, Московская обл., Одинцовский р-н,<br />
                    д.Барвиха, д.144, тел. 8(495)705-99-88<br />
                    ИНН 5032199187 КПП 503201001
                </span>
            </td>
        </tr>
    </table>
...
<table>
            <tr>
                ...
                <td width="80">
                    <img class="bottomImage" src="img/mirBiletaLogo.png" height="38"/> <!--logo  mirBLogo-->
                </td>

                <td width="80">
                    <div id="mirBiletaBottom">
                      ООО &#171;Мир Билета&#187;<br>
                      www.mirbileta.ru
                    </div>
                </td>
...
<img src="img/ticket_bottom.jpg" id="instruction" align="center"/>
  </body>
</html>