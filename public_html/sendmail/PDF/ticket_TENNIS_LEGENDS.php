...
// temp hardcode
$order_id = '313';
$array['ACTION_NAME'] = 'Кубок Дэвиса 2014 Россия-Португалия 12.9';
$array['ACTION_DATE'] = '2014-09-12 16:00:00';
$array['HALL'] = 'СК Олимпийский';
$array['AREA'] = 'Сектор A12';
$array['LINE'] = '17';
$array['PLACE'] = '1';
$array['PRICE'] = 300;
$array['BARCODE_TENNIS'] = 'barcode128.png';
...
// ----------------------------------//
$html.= '
  <div class="barcode_top"><div><img src="'.$array['BARCODE_TENNIS'].'"/></div></div>
  <img class="logo " src=""/>
  <img class="logo mosLogo" src="img/moscowLogo.png" height="50"/>
...
<div class="background">
  ...
  <div class="barcode_left"><div><img src="'.$array['BARCODE_TENNIS'].'"/></div></div>
  ...
  <table class="descr" style="">
    <tr >
      <td width="260">
        ...
        www.tennis-russia.ru in section «Tickets»</span><br/>
      ...
      <td width="260">
        ...
        сайте турнира www.tennis-legends.ru в разделе «Билеты».</span><br/>
