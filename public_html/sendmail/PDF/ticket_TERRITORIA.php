...
$html.='
    ...
    <div class="topLogos" id="headerImage"><img src="img/territoria_logo.jpg"/></div>
    <div class="topLogos" id="mirBil_top_logo"><img src="img/mirBiletaLogo.png"/></div>
    ...
    <table class="legalInfo">
        <tr>
            ...
            <td>
                <span class="KKLegal">
                    Некоммерческая организация Культурный Фонд «Территория»<br />
                    ИНН: 7709657504, КПП: 770901001<br />
                </span>
            </td>
        </tr>
    </table>
